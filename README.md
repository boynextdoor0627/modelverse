...
An interactive bilingual 3D atlas for exploring the world’s major language models as neural DNA constellations.

MODELVERSE 是一个中英双语的交互式三维语言模型图谱，以星系和 DNA 双螺旋的方式呈现主流模型、厂商、参数、上下文与应用信息。
...
- DNA-style company constellations with close-up parameter cards
